...
export const products: Product[] = [
  ...
  },
  {
    id: "ritual-clean",
    name: "Ritual Clean",
    subtitle: "Limpeza + tonificação",
    shortDescription: "Uma dupla prática para começar o ritual com limpeza e tonificação.",
    longDescription: "O Ritual Clean reúne BeClean e BeGlow para as duas primeiras etapas de uma rotina simples, delicada e consistente.",
    benefits: ["BeClean + BeGlow", "Duas etapas coordenadas", "20% de desconto", "Rotina prática"],
    usage: "Use BeClean e, em seguida, aplique BeGlow conforme as orientações de cada embalagem.",
    size: "2 etapas",
    price: 63.84,
    oldPrice: 79.8,
  ...
  },
  {
    ...
    shortDescription: "Duas texturas leves para complementar e finalizar a rotina.",
    ...
    benefits: ["BeCalm + BeSoft", "Rotina simples", "20% de desconto", "Cuidado complementar"],
  ...
  },
  {
    ...
    shortDescription: "Limpar, tonificar, complementar e hidratar em quatro gestos essenciais.",
    longDescription: "O Ritual Completo reúne BeClean, BeGlow, BeCalm e BeSoft em uma sequência completa e objetiva para o dia a dia.",
    benefits: ["Quatro produtos", "Rotina completa", "20% de desconto", "Etapas coordenadas"],
    usage: "Use BeClean, depois BeGlow, aplique BeCalm e finalize com BeSoft.",
    size: "4 produtos",
    price: 171.68,
    oldPrice: 214.6,
    image: assets.hero,
